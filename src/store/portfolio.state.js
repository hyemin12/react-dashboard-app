export const portfolioData = [
  ...
  },
  {
    ...
    describtion:
      "jQery 풀페이지 플러그인을 사용하여 제작하였고, 오마이걸의 앨범 컨셉을 웹사이트에 녹여내려고 하였다. 카드이미지를 클릭하면 해당 페이지로 이동하고, 마지막 이벤트 페이지에서 카드를 클릭하면 모달창이 오픈된다.",
    skills: ["HTML/CSS", "jQuery", "design"],
  ...
  },
  {
    ...
    img2: "lottecard2",
    title: "롯데카드 프로모션 페이지",
    subtitle: "소중한 사람, 가족에게 마음을 선물하세요",
    describtion:
  ...
  },
  {
    ...
    img: "travel",
    title: "여행사 프로모션 페이지",
    subtitle: "Promotion Page Design",
    describtion:
  ...
  },
  {
    ...
    img: "bluewings",
    title: "삼성블루윙즈",
    subtitle: "PHP파일을 수정하여 만든 그누보드 기반의 사이트",
    describtion:
